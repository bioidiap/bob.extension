...
HEADER = (
  ...
  '  set(CMAKE_INCLUDE_SYSTEM_FLAG_CXX "-isystem " CACHE STRING "Sets the -isystem include flag for MacOSX builds" FORCE)\n'
  '  set(CMAKE_INCLUDE_SYSTEM_FLAG_C "-isystem " CACHE STRING "Sets the -isystem include flag for MacOSX builds" FORCE)\n'
